...
var _user$project$Player_Message$None = {ctor: 'None'};
var _user$project$Player_Message$Down = {ctor: 'Down'};
var _user$project$Player_Message$Up = {ctor: 'Up'};
var _user$project$Player_Message$Right = {ctor: 'Right'};
var _user$project$Player_Message$Left = {ctor: 'Left'};
var _user$project$Player_Message$NoOp = {ctor: 'NoOp'};
var _user$project$Player_Message$Move = function (a) {
	return {ctor: 'Move', _0: a};
};
var _user$project$Enemy_Message$Initialize = function (a) {
	return {ctor: 'Initialize', _0: a};
};
var _user$project$Enemy_Message$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _user$project$GameState_Message$NoOp = {ctor: 'NoOp'};
var _user$project$GameState_Message$Toggle = {ctor: 'Toggle'};
var _user$project$Message$NoOp = {ctor: 'NoOp'};
var _user$project$Message$Collision = {ctor: 'Collision'};
var _user$project$Message$GameStateMsg = function (a) {
	return {ctor: 'GameStateMsg', _0: a};
};
var _user$project$Message$EnemyMsg = function (a) {
	return {ctor: 'EnemyMsg', _0: a};
};
var _user$project$Message$PlayerMsg = function (a) {
	return {ctor: 'PlayerMsg', _0: a};
};
var _user$project$Enemy_Commands$initializeEnemies = A2(
	_elm_lang$core$Random$generate,
	_user$project$Enemy_Message$Initialize,
	A2(
		_elm_lang$core$Random$list,
		3,
		A2(
			_elm_lang$core$Random$pair,
			A2(_elm_lang$core$Random$float, -3, 3),
			A2(_elm_lang$core$Random$float, -1, 2))));
var _user$project$Commands$initialCommands = _elm_lang$core$Platform_Cmd$batch(
	_elm_lang$core$Native_List.fromArray(
		[
			A2(_elm_lang$core$Platform_Cmd$map, _user$project$Message$EnemyMsg, _user$project$Enemy_Commands$initializeEnemies)
		]));
var _user$project$Constants$yOffset = 30;
var _user$project$Constants$yStep = 83;
var _user$project$Constants$xStep = 101;
var _user$project$Constants$mapRight = 707 / 2;
var _user$project$Constants$mapLeft = -1 * _user$project$Constants$mapRight;
var _user$project$Constants$mapTop = 303;
var _user$project$Constants$mapBottom = -1 * _user$project$Constants$mapTop;
var _user$project$Enemy_Model$initialEnemy = function (_p0) {
	var _p1 = _p0;
	return {x: _p1._0, y: _p1._1, vx: 0.1, vy: 0};
};
var _user$project$Enemy_Model$enemyWidth = 90;
var _user$project$Enemy_Model$enemyLeft = function (_p2) {
	var _p3 = _p2;
	return _p3.x - (_user$project$Enemy_Model$enemyWidth / 2);
};
var _user$project$Enemy_Model$enemyRight = function (_p4) {
	var _p5 = _p4;
	return _p5.x + (_user$project$Enemy_Model$enemyWidth / 2);
};
var _user$project$Enemy_Model$Enemy = F4(
	function (a, b, c, d) {
		return {x: a, y: b, vx: c, vy: d};
	});
var _user$project$Enemy_Subscriptions$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$animation_frame$AnimationFrame$diffs(_user$project$Enemy_Message$Tick)
			]));
};
var _user$project$Enemy_Update$update = F2(
	function (msg, enemies) {
		var _p0 = msg;
		if (_p0.ctor === 'Tick') {
			return A2(
				_elm_lang$core$List$map,
				function (enemy) {
					return (_elm_lang$core$Native_Utils.cmp(enemy.x, _user$project$Constants$mapRight) > 0) ? _elm_lang$core$Native_Utils.update(
						enemy,
						{x: _user$project$Constants$mapLeft - 50}) : _elm_lang$core$Native_Utils.update(
						enemy,
						{x: enemy.x + (enemy.vx * _p0._0)});
				},
				enemies);
		} else {
			return A2(
				...
				function (_p1) {
					var _p2 = _p1;
					return _user$project$Enemy_Model$initialEnemy(
						{
							ctor: '_Tuple2',
							_0: _user$project$Constants$xStep * _elm_lang$core$Basics$toFloat(
								_elm_lang$core$Basics$floor(_p2._0)),
							_1: _user$project$Constants$yOffset + (_user$project$Constants$yStep * _elm_lang$core$Basics$toFloat(
								_elm_lang$core$Basics$floor(_p2._1)))
						});
				},
				_p0._0);
		}
	});
var _user$project$Enemy_Update$tickEnemy = function (val) {
	return _user$project$Enemy_Message$Tick(val);
};
var _user$project$Enemy_Update$setEnemyPosition = F2(
	function (enemy, _p3) {
		var _p4 = _p3;
		return _elm_lang$core$Native_Utils.update(
			enemy,
...
var _user$project$Enemy_View$view = function (enemy) {
	var enemyImageSrc = '../images/enemy-bug.png';
	var enemyImage = A3(_evancz$elm_graphics$Element$image, 101, 171, enemyImageSrc);
	return A2(
		_evancz$elm_graphics$Collage$move,
		{ctor: '_Tuple2', _0: enemy.x, _1: enemy.y},
		_evancz$elm_graphics$Collage$toForm(enemyImage));
};
var _user$project$GameState_Model$Paused = {ctor: 'Paused'};
var _user$project$GameState_Model$Play = {ctor: 'Play'};
var _user$project$GameState_Subscriptions$isSpaceKeyCode = function (code) {
	return _elm_lang$core$Native_Utils.eq(code, 32);
};
var _user$project$GameState_Subscriptions$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$keyboard$Keyboard$ups(
				function (code) {
					return _user$project$GameState_Subscriptions$isSpaceKeyCode(code) ? _user$project$GameState_Message$Toggle : _user$project$GameState_Message$NoOp;
				})
			]));
};
var _user$project$GameState_Update$update = F2(
	function (msg, state) {
		var _p0 = msg;
		if (_p0.ctor === 'Toggle') {
			return _elm_lang$core$Native_Utils.eq(state, _user$project$GameState_Model$Play) ? _user$project$GameState_Model$Paused : _user$project$GameState_Model$Play;
		} else {
			return state;
		}
	});
var _user$project$GameState_Update$isPaused = function (state) {
	var _p1 = state;
	if (_p1.ctor === 'Paused') {
		return true;
	} else {
...
var _user$project$Player_Model$initialPlayer = {x: 0, y: _user$project$Constants$yOffset - (2 * _user$project$Constants$yStep)};
var _user$project$Player_Model$playerWidth = 60;
var _user$project$Player_Model$playerLeft = function (_p0) {
	var _p1 = _p0;
	return _p1.x - (_user$project$Player_Model$playerWidth / 2);
};
var _user$project$Player_Model$playerRight = function (_p2) {
	var _p3 = _p2;
	return _p3.x + (_user$project$Player_Model$playerWidth / 2);
};
var _user$project$Player_Model$Player = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _user$project$Map_Tile_Model$Tile = F3(
	function (a, b, c) {
		return {tileType: a, x: b, y: c};
	});
var _user$project$Map_Tile_Model$Water = {ctor: 'Water'};
var _user$project$Map_Tile_Model$Grass = {ctor: 'Grass'};
var _user$project$Map_Model$gameMap = A2(
	_elm_lang$core$List$map,
	function (b) {
		return A2(
			_elm_lang$core$List$map,
			function (a) {
				return {tileType: _user$project$Map_Tile_Model$Grass, x: _user$project$Constants$xStep * a, y: _user$project$Constants$yStep * b};
			},
			_elm_lang$core$Native_List.range(-3, 3));
	},
	_elm_lang$core$List$reverse(
		_elm_lang$core$Native_List.range(-2, 2)));
var _user$project$Model$initialModel = {
	player: _user$project$Player_Model$initialPlayer,
	enemies: _elm_lang$core$Native_List.fromArray(
		[]),
	state: _user$project$GameState_Model$Play,
	map: _user$project$Map_Model$gameMap
};
var _user$project$Model$Model = F4(
	function (a, b, c, d) {
		return {player: a, enemies: b, state: c, map: d};
	});
var _user$project$Player_Update$playerEndPoint = {ctor: '_Tuple2', _0: 0, _1: 196};
var _user$project$Player_Update$update = F2(
	function (msg, player) {
		var _p0 = msg;
		if (_p0.ctor === 'Move') {
			var _p1 = _user$project$Player_Update$playerEndPoint;
			var x = _p1._0;
			var y = _p1._1;
			var nextPlayer = function () {
				...
				switch (_p2.ctor) {
					case 'Left':
						return (_elm_lang$core$Native_Utils.cmp(player.x, -300) > 0) ? _elm_lang$core$Native_Utils.update(
							player,
							{x: player.x - _user$project$Constants$xStep}) : player;
					case 'Up':
						return (_elm_lang$core$Native_Utils.cmp(player.y, 190) < 0) ? _elm_lang$core$Native_Utils.update(
							player,
							{y: player.y + _user$project$Constants$yStep}) : player;
					case 'Right':
						return (_elm_lang$core$Native_Utils.cmp(player.x, 300) < 0) ? _elm_lang$core$Native_Utils.update(
							player,
							{x: player.x + _user$project$Constants$xStep}) : player;
					case 'Down':
						return (_elm_lang$core$Native_Utils.cmp(player.y, -130) > 0) ? _elm_lang$core$Native_Utils.update(
							player,
							{y: player.y - _user$project$Constants$yStep}) : player;
					default:
						return player;
			...
			return (_elm_lang$core$Native_Utils.eq(nextPlayer.x, x) && _elm_lang$core$Native_Utils.eq(nextPlayer.y, y)) ? _user$project$Player_Model$initialPlayer : nextPlayer;
		} else {
			return player;
		}
	});
var _user$project$Player_Update$getDirectionFromKeyCode = function (code) {
	var _p3 = code;
	switch (_p3) {
		case 37:
			return _user$project$Player_Message$Move(_user$project$Player_Message$Left);
		case 38:
			return _user$project$Player_Message$Move(_user$project$Player_Message$Up);
		case 39:
			return _user$project$Player_Message$Move(_user$project$Player_Message$Right);
		case 40:
			return _user$project$Player_Message$Move(_user$project$Player_Message$Down);
		default:
			return _user$project$Player_Message$Move(_user$project$Player_Message$None);
	}
};
var _user$project$Player_Update$Context = F2(
	function (a, b) {
		return {player: a, enemies: b};
	});
var _user$project$Update$update = F2(
	function (msg, model) {
		if (_elm_lang$core$Basics$not(
			_user$project$GameState_Update$isPaused(model.state))) {
			var _p0 = msg;
			switch (_p0.ctor) {
				case 'PlayerMsg':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								player: A2(_user$project$Player_Update$update, _p0._0, model.player)
							}),
				...
				case 'EnemyMsg':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								enemies: A2(_user$project$Enemy_Update$update, _p0._0, model.enemies)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'GameStateMsg':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								state: A2(_user$project$GameState_Update$update, _p0._0, model.state)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Collision':
					return {
						...
						_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Message$EnemyMsg, _user$project$Enemy_Commands$initializeEnemies)
					};
				default:
			...
			var _p1 = msg;
			if (_p1.ctor === 'GameStateMsg') {
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							state: A2(_user$project$GameState_Update$update, _p1._0, model.state)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			} else {
...
var _user$project$Player_Subscriptions$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$keyboard$Keyboard$ups(_user$project$Player_Update$getDirectionFromKeyCode)
			]));
};
var _user$project$Subscriptions$detectCollision = F2(
	function (player, enemies) {
		return A2(
			_elm_lang$core$List$any,
			function (enemy) {
				return _elm_lang$core$Native_Utils.eq(player.y, enemy.y) && (((_elm_lang$core$Native_Utils.cmp(
					_user$project$Player_Model$playerLeft(player),
					_user$project$Enemy_Model$enemyRight(enemy)) < 0) && (_elm_lang$core$Native_Utils.cmp(
					_user$project$Player_Model$playerLeft(player),
					_user$project$Enemy_Model$enemyLeft(enemy)) > 0)) || ((_elm_lang$core$Native_Utils.cmp(
					_user$project$Player_Model$playerRight(player),
					_user$project$Enemy_Model$enemyLeft(enemy)) > 0) && (_elm_lang$core$Native_Utils.cmp(
					_user$project$Player_Model$playerRight(player),
					_user$project$Enemy_Model$enemyRight(enemy)) < 0)));
			},
			enemies);
	});
var _user$project$Subscriptions$subscriptions = function (model) {
	var gameSubscriptions = A2(
		_elm_lang$core$Platform_Sub$map,
		function (_p0) {
			return A2(_user$project$Subscriptions$detectCollision, model.player, model.enemies) ? _user$project$Message$Collision : _user$project$Message$NoOp;
		},
		_elm_lang$animation_frame$AnimationFrame$diffs(
			function (_p1) {
				return {ctor: '_Tuple0'};
			}));
	var gameStateSubscriptions = A2(
		_elm_lang$core$Platform_Sub$map,
		function (a) {
			return _user$project$Message$GameStateMsg(a);
		},
		_user$project$GameState_Subscriptions$subscriptions(model.state));
	var enemySubscriptions = A2(
		_elm_lang$core$List$map,
		_elm_lang$core$Platform_Sub$map(
			function (a) {
				return _user$project$Message$EnemyMsg(a);
			}),
		A2(_elm_lang$core$List$map, _user$project$Enemy_Subscriptions$subscriptions, model.enemies));
	var playerSubscriptions = A2(
		_elm_lang$core$Platform_Sub$map,
		function (a) {
			return _user$project$Message$PlayerMsg(a);
		},
		_user$project$Player_Subscriptions$subscriptions(model.player));
	var allSubscriptions = A2(
		...
		A2(
			...
			A2(_elm_lang$core$List_ops['::'], gameSubscriptions, enemySubscriptions)));
	return _elm_lang$core$Platform_Sub$batch(allSubscriptions);
};
var _user$project$Player_View$view = function (player) {
	var playerImageSrc = '../images/char-boy.png';
	var playerImage = A3(_evancz$elm_graphics$Element$image, 101, 171, playerImageSrc);
	return A2(
		_evancz$elm_graphics$Collage$move,
		{ctor: '_Tuple2', _0: player.x, _1: player.y},
		_evancz$elm_graphics$Collage$toForm(playerImage));
};
var _user$project$Map_Tile_View$view = function (tile) {
	var tileImageSrc = function () {
		var _p0 = tile.tileType;
		if (_p0.ctor === 'Grass') {
	...
	var tileImage = A3(_evancz$elm_graphics$Element$image, 101, 171, tileImageSrc);
	return A2(
		_evancz$elm_graphics$Collage$move,
		{ctor: '_Tuple2', _0: tile.x, _1: tile.y},
		_evancz$elm_graphics$Collage$toForm(tileImage));
};
var _user$project$Map_View$view = function (map) {
	return _evancz$elm_graphics$Collage$group(
		A2(
			_elm_lang$core$List$map,
			_user$project$Map_Tile_View$view,
			_elm_lang$core$List$concat(map)));
};
var _user$project$View$view = function (model) {
	var mapView = _user$project$Map_View$view(model.map);
	var enemyViews = _evancz$elm_graphics$Collage$group(
		A2(_elm_lang$core$List$map, _user$project$Enemy_View$view, model.enemies));
	var playerView = _user$project$Player_View$view(model.player);
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A3(
					...
					_elm_lang$core$Basics$round(2 * _user$project$Constants$mapRight),
					_elm_lang$core$Basics$round(2 * _user$project$Constants$mapTop),
					_elm_lang$core$Native_List.fromArray(
						[mapView, enemyViews, playerView])))
			]));
};
var _user$project$Main$subscriptions = _user$project$Subscriptions$subscriptions;
var _user$project$Main$update = _user$project$Update$update;
var _user$project$Main$view = _user$project$View$view;
var _user$project$Main$init = {ctor: '_Tuple2', _0: _user$project$Model$initialModel, _1: _user$project$Commands$initialCommands};
